...
public class EntityGraphAssociationFixerTest {
    ...
    public static class Order {
        ...
        public Set<OrderItem> getOneSidedOrderItems() {
            return oneSidedOrderItems;
        }

        public void setOneSidedOrderItems(
            Set<OrderItem> oneSidedOrderItems) {
            this.oneSidedOrderItems = oneSidedOrderItems;
        }
